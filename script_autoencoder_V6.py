...
import functions.functions_torch_V6 as ft
...
if __name__ == "__main__":
    ...
    BATCH_SIZE = 16  # Optimize the trade off between accuracy and computational time
    ...
    #file_name = "LUNG.csv"
    #file_name = "HIF2.csv"
    #file_name = "LUCAT1.csv"
    #file_name = "Hx3h_SNHG12.csv"
    #file_name = "GC_Brest_D_MB.csv"
    #file_name = "Th12F_meanFill.csv"
    #file_name = "Breast-Milan-200.csv"
    file_name = "Marin-2class.csv"
    #file_name = "Synth_2000f_64inf_1000s.csv"
    ...
    ETA = 5. # Controls feature selection (projection) (L1, L11, L21)
    RHO =3. # Controls feature selection for l1inf
    ...
    if not GRADIENT_MASK:
        ...
        #TYPE_PROJ = ft.proj_l1Inftyball_line_unbounded #
    ...
    for seed in SEEDS:
        ...
        for fold_idx in range(nfolds):
            ...
            if net_name == "FAIR":
                net = ft.FairAutoEncoder(feature_len, class_len, activation=TYPE_ACTIVATION, norm = norm).to(DEVICE)  # FAIR
